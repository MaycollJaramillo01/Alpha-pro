    ...
    <div class="container story-grid">
        <div class="story-copy">
            ...
            <div class="story-actions">
                ...
                <a href="<?php echo $PhoneRef; ?>" class="link-underline"><?php echo htmlspecialchars($storyActions['secondary_prefix'] ?? ($LabelsCopy['call'] ?? '')); ?>: <?php echo htmlspecialchars($Phone); ?></a>
            </div>
        </div>
